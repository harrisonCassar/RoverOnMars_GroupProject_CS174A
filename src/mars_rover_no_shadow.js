...
export class Mars_Rover_No_Shadow extends Scene {
    constructor() {
        ...
        this.shapes = {
            ...
            terrain: new Shape_From_File("assets/MarsWithCavePls.obj"),
    ...
    display(context, program_state) {
        ...
        // draw ground
        this.shapes.terrain.draw(context, program_state, Mat4.translation(0, 55, 0).times(Mat4.scale(600, 600, 600)), this.materials.mars);

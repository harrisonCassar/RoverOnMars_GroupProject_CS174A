...
export class Mars_Rover extends Scene {
    ...
    move_left()
    {
        ...
        this.check_if_colliding_crystals();
    }
    ...
    check_if_colliding_crystals() {
        const CRYSTALS = [[-50, 0, 80], [-55, 0, 80], [-60, 0, 80], [-65, 0, 80], [-70, 0, 80], [-25, 0, -62], [-15, 0, -50], [-252, 0, 0], [-4, 0, -40], [20, 0, -30], [550, 0, -300]];
        //loop between rover position and every crystal position
        for(let i = 0; i < CRYSTALS.length; i++)
            if (this.rover_pos == CRYSTALS[i].pos) {
                //stop drawing CRYSTALS[i]
            }
    }
